...
<body>
	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-9">
			<form action="<%=request.getContextPath()%>/giamgia/insertgg" method="post" >
				<div class="row">
					<!-- Thông tin sản phẩm -->
					<div class="col-lg-6">
						<table class="table">
							...
							<tbody>
							<tr>
									<td><label for="Phamtram" class="h4">Mã giảm giá:</label></td>
									<td><input type="text" id="magiamgia" name="magiamgia"
								...
								<tr>
									...
									<td> <input  class="form-control" type="date" name ="ngayhethan"  id ="ngayhethan"class ="custom-date-input" >
									</td>
								</tr>							
							</tbody>
						</table>
