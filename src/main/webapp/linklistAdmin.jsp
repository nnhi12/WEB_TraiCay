...
<body>
		...
		<a href="<%= request.getContextPath()%>/chitiethoadon/listcthd" class="list-group-item px-3 border-0 rounded-3 list-group-item-info mb-2 pointer">Quản lý đơn hàng</a>
